...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "app/assets/stylesheets/burp/views/pages/edit.less",
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<jquery-migrate-rails>, [">= 0"])
      ...
      s.add_runtime_dependency(%q<font-awesome-less>, ["~> 4.2"])
      ...
      s.add_dependency(%q<jquery-migrate-rails>, [">= 0"])
      ...
      s.add_dependency(%q<font-awesome-less>, ["~> 4.2"])
